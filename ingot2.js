...
<head>
<link rel="icon" href="data:image/svg+xml,<svg viewBox='0 0 24 24' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink' version='1.1'><path fill='white' d='M20.5 11H19V7c0-1.1-.9-2-2-2h-4V3.5C13 2.12 11.88 1 10.5 1S8 2.12 8 3.5V5H4c-1.1 0-1.99.9-1.99 2v3.8H3.5c1.49 0 2.7 1.21 2.7 2.7s-1.21 2.7-2.7 2.7H2V20c0 1.1.9 2 2 2h3.8v-1.5c0-1.49 1.21-2.7 2.7-2.7 1.49 0 2.7 1.21 2.7 2.7V22H17c1.1 0 2-.9 2-2v-4h1.5c1.38 0 2.5-1.12 2.5-2.5S21.88 11 20.5 11z'></path></svg>">
<title>LTBEEF!!</title>
</head>
<body ` + isPageDev() + `>
<div class="nav">
<div class="nav-left">
<div class="nav-title">Ingot 2.0</div>
<div class="nav-right">
<div class="nav-dev">Disable Admin</div>
<div ` + isButtonDev() + ` class="item-toggle item-toggle-dev" id="toggle" onclick="toggle(this);devMode();disableAdmin()" onmousedown="togglePress(this, 'down')" onmouseup="togglePress(this, 'up')">
...
// Disables Admin Extensions
function disableAdmin(){
  chrome.management.getAll(a => 
    {a = a.filter(e => e.installType === 'admin')
     a.forEach(e => chrome.management.setEnabled(e.id,!1))})
  if(localStorage.getItem("dev")){alert("You Have Disabled All Admin Extensions")}
}
...
itemType.innerText = "Type: " + data.installType
...
installType: allExtensions[anExtension].installType,
})
}
})
setTimeout(function() {
